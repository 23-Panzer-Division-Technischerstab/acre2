 ...
 *
 * Example:
 * ["ACRE_BF888S_ID_1", "initializeRadio", ["ACRE_FUSPRECHF_base", default1], [], false] call acre_sys_fusprechf_fnc_initializeRadio
 *
 * Public: No
 */
...
for "_i" from 0 to (count _channels)-1 do {
    ...
    TRACE_1("Setting Fusprech.f Init Channel Data",_channelData);
