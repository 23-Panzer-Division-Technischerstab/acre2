 ...
 *
 * Example:
 * ["ACRE_FUSPRECHF_ID_1", "setState", ["volume", 0.8], _radioData, false] call acre_sys_fusprechf_fnc_setState
 * ["ACRE_FUSPRECHF_ID_1", "setState", ["currentChannel", 1], _radioData, false] call acre_sys_fusprechf_fnc_setState
 *
 * Public: No
 */
